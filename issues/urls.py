...
from .views import all_bugs_fixed, all_bugs_working, all_bugs_todo, all_features_added, all_features_working, all_features_pending, bug_detail, feature_detail, report_bug, suggest_feature, upvote_bug, upvote_feature
